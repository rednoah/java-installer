...
Switch ($JDK_ARCH) {
	AMD64 {
		$JDK_URL = "http://download.oracle.com/otn-pub/java/jdk/10+46/76eac37278c24557a3c4199677f19b62/jre-10_windows-x64_bin.tar.gz"
		$JDK_SHA256 = "0053d9adb4e6d264b3673cc1bb3b1a7b3857ad98e30db0ec659b1381284aa15e"
	}
	default {
